 ...
 * of it.
 *
 * It is panel that appears when modify playlist is clicked in the playlist menu
 *
 *
 ...
 * @since 2022-05-10
 */
public class ModifyPlaylistPanel extends JPanel {
    private static final String MY_PLAYLISTS_LABEL = "My Playlists";
    public static final String BACK_BTN = "BACK_BTN3";
    private static final String BACK_LABEL = "BACK";
    private static final String MODIFY_LABEL = "SELECT PLAYLIST TO MODIFY";
        ...
        jbAddPlaylistJ.addListSelectionListener(new ListSelectionListener() {
            ...
            public void valueChanged(ListSelectionEvent arg0) {
                if (!arg0.getValueIsAdjusting()) {
                    playlistController.setPlaylistModificationInfo(jbAddPlaylistJ.getSelectedValue().toString());
                }
            }
        });
    ...
    /**
     *  Sets the information of the the current user playlist panel if it was
     * @param userPlaylists ArrayList<Playlist>
     */
    public void addPlaylistList(ArrayList<Playlist> userPlaylists) {
        data = new String[100];
    ...
    public void registerPlaylistController(ActionListener listSongsController) {
        playlistController = (PlaylistController)listSongsController;
