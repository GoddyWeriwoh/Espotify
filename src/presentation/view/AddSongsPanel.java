...
public class AddSongsPanel extends JPanel {
    private static final String MY_PLAYLISTS_LABEL = "My Playlists";
    public static final String BACK_BTN = "BACK_BTN6";
        ...
        jbAddPlaylistJ.addListSelectionListener(new ListSelectionListener() {
            ...
            public void valueChanged(ListSelectionEvent arg0) {
                if (!arg0.getValueIsAdjusting()) {
                    playlistController.storeSong(jbAddPlaylistJ.getSelectedValue().toString());
                }
            }
        });
    ...
    public void addSongsList(ArrayList<Song> songList){
        if(songList.size() > 0){
            for (int i = 0; i < songList.size(); i++) {
                data[i] = (songList.get(i).getTitle());
            }
        }
